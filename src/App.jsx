...
const App = () => {
  ...
  return (
    <div>
      <Header/>
      <Hero/>
      <Title  header=' Our Products' />
      <Services animation="fade-left" head='YOUGURT' subhead='Thick, creamy, and chilled—made fresh daily in classic flavors.' content='Our yogurt is smooth, tangy, and refreshingly chilled. Choose Plain, Vanilla, or Strawberry. Always preservative-free and made with care for a naturally satisfying sip.' source={youghurt} />
      <Services animation="fade-right" head='PARFAIT' subhead='Yogurt with fruits and crunchy toppings.' content='This is our “eat well, feel good” cup. Cold, creamy yogurt, ripe seasonal fruit, and a crunchy granola layer. It`s light but filling—breakfast, snack, or dessert that doesn`t weigh you down.' source={parfait} reverse />
      <Services animation="fade-left" head='CHIN CHIN FLAKES' subhead='Crunchy chin-chin slices' content='Buttery, shatter-crisp, and kissed with nutmeg. We fry in small batches so every handful is fresh and crunchy. It`s the snack you keep “tasting” till the pack is empty.' source={chin} />
      <Services animation="fade-right" head='CAKES' subhead='Rich, milky, and not too sugary' content='Our cakes are rich and nutrient-filled—made with plenty of wholesome milk, real butter, and adequate sugar (sweet, not sugary). Soft crumb, moist layers, and smooth frosting that melts on the tongue. From Vanilla to Chocolate to Red Velvet, we bake like we`re serving family.' source={cake} reverse />
      ...
      <Title prefix='How we Deliver' header='Our Processes' />
